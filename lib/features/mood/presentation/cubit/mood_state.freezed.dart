...
mixin _$MoodState {
  ...
  int? get selectedMoodLevel => throw _privateConstructorUsedError;
...
abstract class $MoodStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, int? selectedMoodLevel});
}
...
class _$MoodStateCopyWithImpl<$Res, $Val extends MoodState>
  ...
  @override
  $Res call({Object? isLoading = null, Object? selectedMoodLevel = freezed}) {
    return _then(
      _value.copyWith(
            isLoading: null == isLoading
                ...
                : isLoading // ignore: cast_nullable_to_non_nullable
                      as bool,
            selectedMoodLevel: freezed == selectedMoodLevel
                ? _value.selectedMoodLevel
                : selectedMoodLevel // ignore: cast_nullable_to_non_nullable
                      as int?,
          )
          as $Val,
    );
...
class _$MoodStateImpl implements _MoodState {
  const _$MoodStateImpl({this.isLoading = true, this.selectedMoodLevel});
  ...
  @override
  String toString() {
    return 'MoodState(isLoading: $isLoading, selectedMoodLevel: $selectedMoodLevel)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.selectedMoodLevel, selectedMoodLevel) ||
                other.selectedMoodLevel == selectedMoodLevel));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isLoading, selectedMoodLevel);
