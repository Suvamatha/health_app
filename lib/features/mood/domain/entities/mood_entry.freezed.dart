...
abstract class $MoodEntryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, DateTime loggedAt, int moodLevel});
}
...
class _$MoodEntryImpl implements _MoodEntry {
  ...
  @override
  String toString() {
    return 'MoodEntry(id: $id, loggedAt: $loggedAt, moodLevel: $moodLevel)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, loggedAt, moodLevel);
